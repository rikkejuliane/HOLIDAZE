...
export default function MyVenuesList({ profileName }: Props) {
  ...
  const fetchData = useCallback(
    async (p: number) => {
      ...
      try {
        ...
        setError("Couldn’t load your venues");
      } finally {
        setLoading(false);
      }
    },
  ...
  useEffect(() => {
    ...
    window.addEventListener("venues:updated", onUpdated);
  ...
  async function confirmDelete() {
    ...
    try {
      ...
      setModalErr(
        e instanceof Error ? e.message : "Couldn’t delete the venue."
      );
    } finally {
      setModalBusy(false);
    }
                ...
                <div className="flex items-center gap-7.5 shrink-0">
                  ...
                  <button aria-label="Edit venue" onClick={() => openEdit(v)}>
                    <svg
                      ...
                      <path
                        d="M19.675 4.49104C20.1083 4.05777 20.1083 3.33565 19.675 2.92459L17.0754 0.324955C16.6644 -0.108318 15.9422 -0.108318 15.509 0.324955L13.4648 2.35801L17.6309 6.52409M0 15.8339V20H4.16609L16.4533 7.70171L12.2872 3.53562L0 15.8339Z"
                        fill="#FCFEFF"
                        fillOpacity="0.7"
                      />
                    </svg>
