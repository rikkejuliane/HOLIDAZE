      ...
      <div className="flex flex-row gap-[45px]">
        ...
        <div className="relative">
          <img
            ...
            alt="Placeholder"
            className="w-[720px] h-[670px] object-cover"
          />
          <div className="absolute top-7 left-1/2 -translate-x-1/2 -translate-y-1/2  flex flex-row items-center w-[200px] h-[38px] mx-auto rounded-[10px]  bg-secondary/10  border border-secondary/0 backdrop-blur-[5.10px]">
            {/* Photos tab */}
            <button
              type="button"
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-row gap-[32px] items-center cursor-pointer">
            {/* Prev image */}
        ...
        <div className="flex flex-col">
          <Link
            href="/"
            className="flex flex-row gap-1.5 items-center font-jakarta font-bold text-primary mb-[34px]">
            <svg
              width="7"
              height="12"
              viewBox="0 0 7 12"
          ...
          <h1 className="font-noto text-white font-bold text-[35px] leading-tight mb-5">
            Cozy Cabin in the Woods
          </h1>
          <p className="max-w-[590px] font-jakarta text-primary text-sm leading-tight mb-5">
          ...
          <div className="flex items-center gap-2 text-primary/60 text-[17px] font-light font-jakarta leading-tight mb-5">
            <span>
          ...
          <div className="flex flex-row gap-[15px]">
            <div className="w-48 h-36 bg-secondary rounded-3xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-4 flex flex-col font-jakarta text-primary text-xs">
            ...
            <div className="w-48 h-36 bg-secondary rounded-3xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]"></div>
          </div>
        </div>
      </div>
    </section>
